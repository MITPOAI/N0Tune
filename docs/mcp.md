...
The MCP server lives in `integrations/mcp-server`.
...
Claude Code, Cursor-style tools, and other MCP-compatible clients can use the same command and environment.
